...
add name=Derick_Profile mode=dynamic-keys authentication-types=wpa2-psk unicast-ciphers=aes-ccm group-ciphers=aes-ccm wpa2-pre-shared-key="D86S80MAQ"

/interface wireless
set [ find default-name=wlan1 ] mode=station ssid="Derick_Wifi" security-profile=Derick_Profile disabled=no

/ip dhcp-client
add interface=wlan1 disabled=no add-default-route=yes use-peer-dns=yes
